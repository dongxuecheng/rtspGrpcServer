...
namespace NALU
{
    ...
    inline const char *nal_unit_type_string(nal_unit_type_t t)
    {
        switch (t)
        {
        case nal_unit_type_t::unuse:
            return "unuse";
        case nal_unit_type_t::slice_nonidr_layer_without_partitioning_rbsp:
            return "slice_nonidr_layer_without_partitioning_rbsp";
        case nal_unit_type_t::slice_data_partition_a_layer_rbsp:
            return "slice_data_partition_a_layer_rbsp";
        case nal_unit_type_t::slice_data_partition_b_layer_rbsp:
            return "slice_data_partition_b_layer_rbsp";
        case nal_unit_type_t::slice_data_partition_c_layer_rbsp:
            return "slice_data_partition_c_layer_rbsp";
        case nal_unit_type_t::slice_idr_layer_without_partitioning_rbsp:
            return "slice_idr_layer_without_partitioning_rbsp";
        case nal_unit_type_t::sei_rbsp:
            return "sei_rbsp";
        case nal_unit_type_t::seq_parameter_set_rbsp:
            return "seq_parameter_set_rbsp";
        case nal_unit_type_t::pic_parameter_set_rbsp:
            return "pic_parameter_set_rbsp";
        case nal_unit_type_t::access_unit_delimiter_rbsp:
            return "access_unit_delimiter_rbsp";
        case nal_unit_type_t::end_of_seq_rbsp:
            return "end_of_seq_rbsp";
        case nal_unit_type_t::end_of_stream_rbsp:
            return "end_of_stream_rbsp";
        case nal_unit_type_t::filler_data_rbsp:
            return "filler_data_rbsp";
        case nal_unit_type_t::seq_parameter_set_extension_rbsp:
            return "seq_parameter_set_extension_rbsp";
        case nal_unit_type_t::reserve:
            return "reserve";
        case nal_unit_type_t::slice_layer_without_partitioning_rbsp:
            return "slice_layer_without_partitioning_rbsp";
        case nal_unit_type_t::reserve2:
            return "reserve2"; // 20..23  reserve
        case nal_unit_type_t::unuse2:
            return "unuse2"; // 24..31 unuse
        default:
            return "unknow";
        }
    }
    ...
    inline const char *slice_type_string(slice_type_t t)
    {
        ...
        switch (t)
        {
        case slice_type_t::EX_P:
            return "P";
        case slice_type_t::P:
            return "P";
        case slice_type_t::EX_B:
            return "B";
        case slice_type_t::B:
            return "B";
        case slice_type_t::EX_I:
            return "I";
        case slice_type_t::I:
            return "I";
        case slice_type_t::EX_SP:
            return "SP";
        case slice_type_t::SP:
            return "SP";
        case slice_type_t::EX_SI:
            return "SI";
        case slice_type_t::SI:
            return "SI";
        case slice_type_t::UNKNOW:
            return "UNKNOW";
        default:
            return "UNKNOW";
        }
